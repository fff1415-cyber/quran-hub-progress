...
import { loadRoleAccountsCloud, upsertRoleAccount, deleteRoleAccount, pushHalaqat, deleteHalaqa, type CloudRoleAccount } from "@/lib/cloud-sync";
import { StudentImportPanel, StudentsManagementPanel } from "@/components/admin/StudentsAdminPanel";
import { AppHeader } from "@/components/AppHeader";
import { Plus, Trash2, Users, BookOpen, Key, Settings as SettingsIcon, FileSpreadsheet, Loader2, Save } from "lucide-react";
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        {tab === "import" && <StudentImportPanel />}
        {tab === "halaqat" && <HalaqatTab />}
        {tab === "students" && <StudentsManagementPanel />}
        {tab === "codes" && <CodesTab />}
